...
sources:
  ...
  - https://bookstore.ams.org/gsm-214/
  - https://www.ocw.iti.hr/course/view.php?id=23
  - https://arxiv.org/abs/2207.13136
...
| 5 | [Portfolio Theory and Arbitrage (Karatzas & Kardaras, AMS)](https://bookstore.ams.org/gsm-214/) | Book (AMS) | Portfolio theory + arbitrage math |
| 6 | [Lecture Notes & Slides (ocw.iti.hr)](https://www.ocw.iti.hr/course/view.php?id=23) | Course | Quant lecture notes |
| 7 | [Signature-based models: theory and calibration (Cuchiero et al.)](https://arxiv.org/abs/2207.13136) | Paper | Signature methods — modern path-based finance math (closest verified match) |
